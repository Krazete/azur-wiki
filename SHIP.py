...
shipnames = { # run buildskinname to check what these should be
    ...
    'npcaersasi_3': 'Alsace_NO_BASE2',
    'npcbulunnusi_3': 'Brennus_NO_BASE',
    'npcguandao_3': 'Guam_NO_BASE',
    'npcjiasikenie_3': 'Gascogne_NO_BASE2',
    'npclafeiii_4': 'Laffey II_NO_BASE2',
    'npcyanzhan_4': 'Warspite_NO_BASE3',
    'npcyunxian_3': 'Unzen_NO_BASE',
    'qianjian': 'Asama',
    'qianjian_2': 'AsamaNinja',
    'shuiwulai': 'Minase',
    'shuiwulai_2': 'MinaseNinja',
    'shuiwulai_bj1': 'UNKNOWN',
    'shuiwulai_bj2': 'UNKNOWN2',
